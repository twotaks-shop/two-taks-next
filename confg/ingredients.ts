export const tabs = [
	{
		...
		title: "Start your day like a superhuman",
		description:
			"Forget coffee and sugary energy drinks — Super Morning is your all-in-one morning capsule for an unstoppable physical and mental kickstart. Packed with adaptogens, antioxidants, and natural compounds, this formula delivers:\n\n• Long-lasting energy\n• Crash-free stamina\n• Vitality from within\n\nThe boost your body and mind have been waiting for.",
		ingredients: [
			{
				id: "cordyceps-mushroom-extract",
	...
	},
	{
		...
		title: "Strengthen your defenses. Feel what it means to be truly protected.",
		description:
			"In an unpredictable world, you need more than luck to stay healthy. Super Immune is your daily shield — a powerful blend of natural ingredients that support your immune system and help you perform at your best, no matter the environment. Packed with essential vitamins, medicinal mushrooms, and science-backed superfoods, this capsule works from within so nothing slows you down.\n\n• Stronger immunity\n• Fewer sick days\n• More energy to live at 100%\n\nYour health isn’t optional. Protect it like a superhuman.",
		ingredients: [
			{
				id: "vitamin-c",
				name: "Vitamin C",
	...
	},
	{
		...
		title: "Sleep like never before. Perform like always.",
		description:
			"Good sleep isn’t a luxury — it’s your foundation for feeling unstoppable. Super Sleep blends time-honored botanicals with modern natural science to help you fall asleep faster, rest deeper, and wake up recharged. Forget insomnia, racing thoughts, or chronic fatigue. This capsule is your nightly gateway to real, restorative rest.\n\n• Deep, high-quality sleep\n• Less nighttime anxiety\n• More energy in the morning\n\nEven superhumans need great sleep.",
		ingredients: [
			{
				id: "vitamin-b6",
	...
	},
	{
		...
		title: "Activate your super brain and take control.",
		description:
			"What if you could think faster, focus for hours, and recall information with ease? Super Brain is an advanced formula made with natural nootropics and smart adaptogens that work in synergy to elevate your mind. Sharpen your focus, boost memory, and accelerate learning — with no crashes or anxiety. Perfect for students, professionals, creatives, or anyone aiming to perform at their mental best.\n\n• Clearer thinking\n• Faster mental processing\n• More confidence to stand out\n\nBecause when your brain performs at its best... everything changes.",
		ingredients: [
			{
				id: "alpha-gpc",
